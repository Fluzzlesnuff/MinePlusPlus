...
class Player {
  ...
  public:
    ...
    CoordPair getCoords(xcoord_t xOffset = 0, ycoord_t yOffset = 0) const; // By default, returns the player's coordinates. If offsets are supplied, returns the offset coordinates.
    ExactCoordPair getExactCoords(double xOffset = 0, double yOffset = 0) const;
};
