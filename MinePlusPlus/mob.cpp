...
int Mob::drop (id_t id1, id_t num1 = 1) {

}

int Mob::dropRand (id_t id1, id_t num1, float chance1, id_t num2 = 0, float chance2 = 0, id_t num3 = 0, float chance3 = 0 ) {

}

void Mob::follow (bool safety = true) {
